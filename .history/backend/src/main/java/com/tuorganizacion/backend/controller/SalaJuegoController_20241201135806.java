...
public ResponseEntity<?> crearSala(@RequestBody SalaRequest salaRequest) {
    try {
        ...
        // Guarda el usuario en la base de datos (ajustar según tu repositorio y lógica de persistencia)
        usuarioRepository.save(usuario);

        // Resto del código para crear la sala
