...
public class PlayerResponseService {
  ...
  public boolean submitPlayerResponse(
    ...
    Respuesta respuesta = new Respuestaespuesta();
    respuesta.setGameSession(gameSession);
    respuesta.setPlayer(player);
    respuesta.setQuestion(question);
    respuesta.setSelectedAnswer(selectedAnswer);
